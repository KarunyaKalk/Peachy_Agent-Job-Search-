    ...
    <div className="min-h-screen bg-dark-bg flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md glass-panel p-8 relative z-10 space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-bold text-white tracking-tight">Welcome to Peachy</h1>
          <p className="text-xs text-dark-muted">Sign in to your personal AI job search workspace</p>
        </div>
        ...
        <div className="text-center pt-2 border-t border-dark-border/60">
          <p className="text-xs text-dark-muted">
            First time using Peachy?{' '}
            <Link to="/register" className="text-peach-400 hover:underline font-medium">
              Create an account
            </Link>
          </p>
        </div>
